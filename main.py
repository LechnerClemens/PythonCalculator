...
button7 = tk.Button(canvas, text="7", width=10, height=5)
button7.grid(column=0, row=0)
button8 = tk.Button(canvas, text="8", width=10, height=5)
button8.grid(column=1, row=0)
button9 = tk.Button(canvas, text="9", width=10, height=5)
button9.grid(column=2, row=0)
button4 = tk.Button(canvas, text="4", width=10, height=5)
button4.grid(column=0, row=1)
button5 = tk.Button(canvas, text="5", width=10, height=5)
button5.grid(column=1, row=1)
button6 = tk.Button(canvas, text="6", width=10, height=5)
button6.grid(column=2, row=1)
button1 = tk.Button(canvas, text="1", width=10, height=5)
button1.grid(column=0, row=2)
button2 = tk.Button(canvas, text="2", width=10, height=5)
button2.grid(column=1, row=2)
button3 = tk.Button(canvas, text="3", width=10, height=5)
